...
fn get_short_uuid(length: usize) -> String {
    // Generate a new UUID and get the specified number of characters as a string
...
pub fn exam_routes() -> Scope {
    actix_web::web::scope("/exam")
        ...
        .service(web::resource("/{exam_id}").route(web::get().to(get_exam)))
}
        ...
        pipe.hset_multiple(
            ...
            &[
                ...
                (
                    ...
                    &serde_json::to_string(&question.options).unwrap(),
                ),
                (
                    RedisSchema::FIELD_CORRECT_OPTION,
...
async fn fetch_questions(
    ...
    // Spawn tasks to fetch metadata for each question concurrently.
    for key in question_keys {
        ...
        tasks.push(task::spawn(async move {
            ...
            let question = models::QuestionResponse {
                ...
                .unwrap_or(vec![]),
                correct_option: metadata
                    .get(RedisSchema::FIELD_CORRECT_OPTION)
